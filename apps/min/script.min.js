...
function compileContent() {
    ...
    var b = {
        ...
        work_day: {
            ...
            company: '<a href="http://osiris.agency">Dentsu Aegis Network</a>',
            location: "Colombo, Sri Lanka"
        },
		work_night: {
            position: ["Senior Developer", "Illustrator"],
        ...
        contact: ['<a class="item" href="mailto:' + a + '">' + a + "</a>", '<a class="item" href="http://www.linkedin.com/in/kostasr">WhatsApp</a>', '<a class="item" href="http://instagram.com/thatsparrow">Instagram</a>'],
		links: ['<a class="item" href="http://instagram.com/thatsparrow">Portfolio</a>', '<a class="item" href="http://www.linkedin.com/in/kostasr">Resume</a>', '<a class="item" href="http://instagram.com/thatsparrow">Blog</a>']
    };
