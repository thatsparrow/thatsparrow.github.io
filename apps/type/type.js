...
(function() {
  ...
  Type = (function() {
    Type.prototype.int = 100;

    Type.prototype.accuracy = .95;

    Type.prototype.keys = 'qwertyuiopasdfghjklzxcvbnm,./;-=[]'.split('');

    function Type(el, text, options) {
      ...
      if (!(this instanceof Type)) {
        return new Type(this.el, this.text, this.options);
      }
    ...
    Type.prototype.clear = function(n) {
      if (n == null) {
        n = this.len;
      }
      if (n === -2) {
